...
import logoMidas from '../assets/logo.png'

export function Footer() {
  const currentYear = new Date().getFullYear()

  return (
    <footer className="bg-slate-950 text-slate-200 border-t border-slate-900 pb-20">
      <div className="container py-12 md:py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="space-y-6">
            <Link to="/" className="flex items-center gap-4 group">
              <div className="flex items-center justify-center w-14 h-14 bg-white border border-slate-300 rounded-full">
                <img
                  src={logoMidas}
                  alt="MIDAS Locações & Serviços"
                  className="h-10 w-auto object-contain"
                />
              </div>

              <div className="flex flex-col leading-tight">
                <span className="text-xl font-heading font-black tracking-tight text-secondary">
                  MIDAS
                </span>
            ...
            <div className="flex gap-4 pt-2">
              ...
              <a href="#" className="w-10 h-10 flex items-center justify-center border border-slate-800 hover:border-secondary hover:text-secondary transition-all" aria-label="Facebook">
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm font-medium">
              <li><Link to="/sobre" className="text-slate-400 hover:text-secondary transition-colors flex items-center gap-2"><div className="w-1 h-1 bg-slate-700"></div> A Empresa</Link></li>
              <li><Link to="/servicos" className="text-slate-400 hover:text-secondary transition-colors flex items-center gap-2"><div className="w-1 h-1 bg-slate-700"></div> Nossos Serviços</Link></li>
              ...
              <li><Link to="/blog" className="text-slate-400 hover:text-secondary transition-colors flex items-center gap-2"><div className="w-1 h-1 bg-slate-700"></div> Blog Técnico</Link></li>
              <li><Link to="/contato" className="text-slate-400 hover:text-secondary transition-colors flex items-center gap-2"><div className="w-1 h-1 bg-slate-700"></div> Fale Conosco</Link></li>
            </ul>
          </div>
            ...
            <ul className="space-y-6 text-sm">
              <li className="flex items-start gap-4 group">
                ...
                <span className="text-slate-400 leading-relaxed">
                  Base Operacional:<br />
                  <span className="text-white">Rio Paranaíba – MG</span><br />
              ...
              <li className="flex items-center gap-4 group">
                ...
                <a href="mailto:contato@midaslsltda.com.br" className="hover:text-white text-slate-400">
        ...
        <div className="mt-16 pt-8 border-t border-slate-900 flex flex-col md:flex-row justify-between items-center gap-4 text-xs font-mono text-slate-600">
          <p>
            &copy; {currentYear} MIDAS LOCAÇÕES & SERVIÇOS. Desenvolvido por:{' '}
            <a
              href="https://olliverdigital.com.br"
              target="_blank"
